...
# 2. sudo ./upgrade_docker-compose.sh v2.3.0
# 3. sudo DOCKER_COMPOSE_VERSION=v2.3.0 ./upgrade_docker-compose.sh
#
...
# Example:
#
#  DOCKER_COMPOSE_PLATFORM=linux ./upgrade_docker-compose.sh v2.3.0
#
# -----
#
...
# Example:
#
#  DOCKER_COMPOSE_ARCHITECTURE=armv7 ./upgrade_docker-compose.sh v2.3.0
#
# -----
#
# Despite the name, this script will also downgrade. If, for example,
# you are running docker-compose v2.3.0 and want to revert to v2.2.2
...
DOCKER_COMPOSE_VERSION_DEFAULT="v2.3.0"
