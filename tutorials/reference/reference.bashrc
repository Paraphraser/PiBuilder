...
# will be cleaned-up by tidyPATH if local bin does not exist
PATH="$HOME/.local/bin:$PATH"

# If not running interactively, don't do anything except path cleanup
case $- in
    *i*) ;;
      *) export PATH=$(tidyPATH) ; return ;;
esac
...
# display date and time in history output
