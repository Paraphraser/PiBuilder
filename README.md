...
* «version» is the value on the [releases page](https://github.com/docker/compose/releases) and always starts with a "v". For example:
	...
	```bash
	$ sudo /boot/scripts/helpers/upgrade_docker-compose.sh v2.4.0
	```
...
* 2022-03-10
	...
	- Bump docker-compose to v2.4.0 (this version supports `device_cgroup_rules` - see [PR9251](https://github.com/docker/compose/pull/9251))
